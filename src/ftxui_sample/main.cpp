...
// configuration step. It creates a namespace called `DKEngine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", DKEngine::cmake::project_name, DKEngine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", DKEngine::cmake::project_version);
      return EXIT_SUCCESS;
    }
